// This is the test class for leaving image files
...
public class testLeaving {
	public static void main(String[] args) throws InterruptedException {
		//Create the test object to test images inside "leaving" folder.
		Main test = new Main("leaving");
		test.main();
	}
}
